...
class VAE(tf.keras.Model):
    ...
    def call(self, x):
        """
        Performs forward pass through FC-VAE base_model by passing image through
        ...
        Returns:
        - x_hat: Reconstruced input images of shape (N,1,H,W)
        ...
        # (1) Pass the input batch through the encoder base_model to get posterior mu and logvariance   #
...
class CVAE(tf.keras.Model):
    ...
    def call(self, x, c):
        """
        Performs forward pass through FC-CVAE base_model by passing image through
        encoder, reparametrize trick, and decoder models
        ...
        ############################################################################################
        # Implement the forward pass by following these steps                                #
        # (1) Pass the concatenation of input batch and one hot vectors through the encoder base_model  #
...
def reparametrize(mu, logvar):
    """
    Differentiably sample random Gaussian images with specified mean and variance using the
